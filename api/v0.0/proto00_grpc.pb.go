...
func (c *linkerClient) Info(ctx context.Context, in *InfoReq, opts ...grpc.CallOption) (*InfoRes, error) {
	out := new(InfoRes)
	err := c.cc.Invoke(ctx, "/Linker/Info", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *linkerClient) Subscribe(ctx context.Context, in *SubscribeReq, opts ...grpc.CallOption) (Linker_SubscribeClient, error) {
	stream, err := c.cc.NewStream(ctx, &Linker_ServiceDesc.Streams[0], "/Linker/Subscribe", opts...)
	if err != nil {
		return nil, err
	}
	x := &linkerSubscribeClient{stream}
...
func _Linker_Subscribe_Handler(srv interface{}, stream grpc.ServerStream) error {
	...
	return srv.(LinkerServer).Subscribe(m, &linkerSubscribeServer{stream})
}
